...
export class TTSPMap {
  ...
  getDistance (cityA:number, cityB:number) : number {
		let x: number = this.fCoordinates[cityA][TTSPMap.COORD_X] - this.fCoordinates[cityB][TTSPMap.COORD_X];
		let y: number = this.fCoordinates[cityA][TTSPMap.COORD_Y] - this.fCoordinates[cityB][TTSPMap.COORD_Y];
